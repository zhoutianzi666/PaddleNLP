            ...
            if self.config.mla_config.use_mla():
                if self.config.mla_config.q_lora_rank is None:
                    ...
                    q_proj_weight_scale = self.create_parameter(
                        shape=[self.q_proj_weight_shape[0]],
